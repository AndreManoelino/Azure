...
namespace CorporateIdentityManager.Migrations
{
    ...
    [Migration("20260420202909_InventarioEHolerites")]
    partial class InventarioEHolerites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CorporateIdentityManager.Domain.Entities.Candidato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CurriculoTexto")
                        .IsRequired()
            ...
            modelBuilder.Entity("CorporateIdentityManager.Domain.Entities.DocumentoRelatorio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("DepartamentoRelacionado")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("DocumentosRelatorios");
                });
            ...
            modelBuilder.Entity("CorporateIdentityManager.Domain.Entities.Vaga", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CorporateIdentityManager.Domain.Entities.Candidato", b =>
                {
                    b.HasOne("CorporateIdentityManager.Domain.Entities.Vaga", "Vaga")
                        .WithMany()
            ...
            modelBuilder.Entity("CorporateIdentityManager.Domain.Entities.FotoPerfil", b =>
                {
                    b.HasOne("CorporateIdentityManager.Domain.Entities.Usuario", "Usuario")
                        .WithOne("FotoPerfil")
                        .HasForeignKey("CorporateIdentityManager.Domain.Entities.FotoPerfil", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
